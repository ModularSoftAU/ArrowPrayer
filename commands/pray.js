...
const { databaseIssue, prayerChannelNotSet, prayerLogChannelNotSet } = require('../embeds');
              ...
              if (error) {
                ...
                return;
                  ...
                  try {
                    ...
                    let prayerRequestLogToggle = results[0].prayerLogEnable;
